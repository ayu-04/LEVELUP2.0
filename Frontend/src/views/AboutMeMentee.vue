...
<div class="aboutmecard container d-flex flex-column gap-3 px-5" style="width: 55rem">
  <div class="text-center">
    ...
    <router-link style="position:absolute; top:0; right:0;margin-top: 5px;margin-right: 10px;" :to="{name: 'EditAboutMeMentee', params: {username: $route.params.username}}"><pinkBtn><b>EDIT</b></pinkBtn></router-link>
  </div>
...
<div class="d-flex flex-row">
  <div class="d-flex flex-column gap-3" style="width: 40%">
    ...
    <p1>Weaknesses: <span v-for="i in weaknesses">{{i+'  '}}</span></p1>
    <p1>Age: {{age}}</p1>
